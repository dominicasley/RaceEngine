                                                                       ...
                                                                       const std::string_view source) const
{
    ...
    if (table->domainMinimum != 0.0f || table->domainMaximum != 1.0f)
    {
        ...
        return std::unexpected("colour grade '" + name + "' is defined over " +
                               std::to_string(table->domainMinimum) + ".." + std::to_string(table->domainMaximum) +
                               "; this engine samples tables over 0..1");
    }
